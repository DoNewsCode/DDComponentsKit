//
//  SectionExampleViewController.m
//  DDTest
//
...
#import "SectionExampleViewController.h"
...
@interface SectionExampleViewController ()
...
@implementation SectionExampleViewController
...
- (void)viewDidLoad {
    ...
    TGTitlesComponent *titlesCompnent = [[TGTitlesComponent alloc] init];
    titlesCompnent.cellModels = self.titleModels;
    
    TGTextComponent *textsCompnent = [[TGTextComponent alloc] init];
    textsCompnent.cellModels = self.textModels;
    
    TGImagesComponent *imageCompnent = [[TGImagesComponent alloc] init];
    imageCompnent.headerComponent = self.headerComponent;
    imageCompnent.footerComponent = self.footerComponent;
    
    imageCompnent.images = self.imageModels;
    imageCompnent.sectionInset = UIEdgeInsetsMake(0, 15, 0, 15);
    
    self.rootComponent.subComponents = @[titlesCompnent, textsCompnent, imageCompnent];
